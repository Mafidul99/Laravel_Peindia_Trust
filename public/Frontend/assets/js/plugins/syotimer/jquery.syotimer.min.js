...
! function(i, e) { "function" == typeof define && define.amd ? define(["jquery"], i) : "object" == typeof module && module.exports ? module.exports = function(e, t) { return void 0 === t && (t = "undefined" != typeof window ? require("jquery") : require("jquery")(e)), i(t), t } : i(e) }(function(l) {
    var m = "day",
        ...
        c = {
            ...
            _render: function() {
                for (var e = l(this), t = e.data("syotimer-options"), i = y.getTimerItem(), n = l("<span/>", { class: "syotimer__head" }).html(t.headTitle), o = l("<span/>", { class: "syotimer__body" }), r = l("<span/>", { class: "syotimer__footer" }).html(t.footTitle), a = {}, s = 0; s < t.itemTypes.length; s++) {
                    var d = i.clone();
        ...
        y = {
            getTimerItem: function() {
                var e = l("<span/>", { class: "syotimer-cell__value", text: "0" }),
                    t = l("<span/>", { class: "syotimer-cell__unit" }),
                    i = l("<span/>", { class: "syotimer-cell" });
